...
const ytdlpResolver = require("../services/resolvers/ytdlp.resolver");

// Modular high-performance resolvers
const { extractVoe } = require("../services/resolvers/voe.resolver");
const { extractStreamwish } = require("../services/resolvers/streamwish.resolver");
const { extractStreamtape } = require("../services/resolvers/streamtape.resolver");
